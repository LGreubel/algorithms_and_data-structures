...
//Heap
        public static <T> void heapsort(Integer[] arr) {
...
//Quick
        ...
        static <T> void randomizedQuicksort(Integer[] arr) {
            randomizedQuicksort(arr, 0, arr.length -1);
        }
        public static <T> void randomizedQuicksort(Integer[] arr, int left, int right) {
            if (left < right) {
        ...
        private static <T> int randomPartition(Integer[] arr, int left, int right) {
